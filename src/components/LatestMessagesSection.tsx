    ...
    <section className="bg-background section-padding">
      <div className="container-custom">
        <MotionInView duration={0.8} className="text-center mb-6 sm:mb-8 md:mb-12">
          <h2 className="heading-lg text-foreground">Latest Messages</h2>
        </MotionInView>

        <div className="grid grid-cols-2 md:grid-cols-2 gap-2 sm:gap-4 md:gap-6 max-w-4xl mx-auto">
          {/* Latest Video Card */}
          <MotionInView direction="left">
            <Card className="hover:shadow-lg transition-shadow h-full bg-card border-border">
              <CardHeader className="text-center pb-2 sm:pb-4">
                ...
                <CardTitle className="font-serif text-foreground text-xs sm:text-sm md:text-base">Latest Video</CardTitle>
              </CardHeader>
              <CardContent className="text-center px-2 sm:px-6 pb-3 sm:pb-6">
                <p className="text-muted-foreground mb-2 sm:mb-4 text-xs sm:text-sm md:text-base">
          ...
          <MotionInView direction="right">
            <Card className="hover:shadow-lg transition-shadow h-full bg-card border-border">
              <CardHeader className="text-center pb-2 sm:pb-4">
                ...
                <CardTitle className="font-serif text-foreground text-xs sm:text-sm md:text-base">Latest Audio</CardTitle>
              </CardHeader>
              <CardContent className="text-center px-2 sm:px-6 pb-3 sm:pb-6">
                <p className="text-muted-foreground mb-2 sm:mb-4 text-xs sm:text-sm md:text-base">
