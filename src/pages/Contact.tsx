        ...
        <section className="section-padding bg-black">
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-primary/20 p-3 rounded-full text-primary hover:bg-primary/30 transition-colors">
              ...
              {/* Contact Form */}
              <div>
                <h2 className="heading-md mb-8 text-white">Send Us a Message</h2>
