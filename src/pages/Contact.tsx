        ...
        <section className="section-padding bg-background">
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Contact Information */}
              <div>
                <h2 className="heading-md mb-8 text-foreground">Get In Touch</h2>
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-base mb-1 text-foreground">Church Location</h3>
                      <p className="text-muted-foreground">Haven Word Church<br />The Spread City<br />9VXM+797 Haven Word Church, 107D Akintola Rd, Ibadan 200284, Oyo</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        <a href="tel:+2348158884938" className="hover:text-primary transition-colors">+234 815 888 4938</a>
                      </p>
                      <p className="text-muted-foreground">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        <a href="mailto:havenwordchurch@gmail.com" className="hover:text-primary transition-colors">havenwordchurch@gmail.com</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Contact Form */}
              <div>
                <h2 className="heading-md mb-8 text-foreground">Send Us a Message</h2>
                
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label htmlFor="name" className="block text-sm font-medium text-muted-foreground">Your Name</label>
