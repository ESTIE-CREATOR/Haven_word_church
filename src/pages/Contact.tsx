              ...
              <div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-church-50 p-3 rounded-full text-white hover:bg-church-100 transition-colors">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <InteractiveHoverButton 
                      ...
                      className="w-full bg-church-600 hover:bg-church-700 border-church-600"
